...
public abstract class BigEndian {
	...
	public static int getInt(byte[] bytes, int offset) {
		return ((((bytes[offset] << 24) & -16777216) | ((bytes[offset + 1] << 16) & 16711680))
				| ((bytes[offset + 2] << 8) & 65280)) | (bytes[offset + 3] & 255);
	}
	...
	public static long getLong(byte[] bytes, int offset) {
		return ((((long) getInt(bytes, offset)) & 4294967295L) << 32)
				| (((long) getInt(bytes, offset + 4)) & 4294967295L);
	}
