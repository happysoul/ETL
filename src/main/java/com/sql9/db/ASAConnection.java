...
public class ASAConnection extends DBConnection {
    public ASAConnection(CommonDB db) throws Exception {
        super(db);
    }
    ...
    protected String _$1(boolean isAutoIncrement, boolean isSigned, int isNullable, boolean isAutoIdentity, int stdType, int length, int precision, int scale) {
        ...
        switch (stdType) {
            ...
            case -6:
                ...
                break;
            case -5:
                t = isSigned ? "BIGINT" : "UNSIGNED BIGINT";
                break;
            case -4:
            case 2004:
                t = "IMAGE";
            ...
            case 3:
                ...
                break;
            case 4:
                t = isSigned ? "INT" : "UNSIGNED INT";
                break;
            case 5:
                t = isSigned ? "SMALLINT" : "UNSIGNED SMALLINT";
                break;
            case 6:
            case 7:
                t = "REAL";
